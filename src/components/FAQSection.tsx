...
const faqItems = [
  ...
  { id: 'faq-3', question: 'Como funciona o modo Direto e o Didático?', answer: 'Você escolhe isso no próprio chat. No modo Direto, a CLARA prioriza uma orientação mais curta e objetiva. No modo Didático, ela organiza a resposta em etapas, com mais contexto e conferências. A preferência fica salva no navegador para as próximas perguntas.' },
